...
<section class="main-section">
    ...
    <section class="search-section">
            <form action="<?php echo SITEURL; ?>/customers/food-search.php" method="POST">
                <input type="search" name="search" placeholder="Search Desserts..." required class="search-box" size="60">
    ...
    <?php
        ...
        $sql = "SELECT * FROM tbl_dessert WHERE active='Yes'";
